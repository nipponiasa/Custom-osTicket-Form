...
10. Υλοποίηση της λειτουργικότητας για την ενημέρωση των πεδίων της φόρμας με πργαματικά δεδομένα από το ERP. 
11. Προαιρετικό. Ενσωμάτωση CSRF token protection και στο custom form submit flow, ώστε το endpoint της φόρμας να προστατεύεται και με explicit anti-CSRF μηχανισμό πέρα από το login/session validation.
